...
#define ARRAY_SIZE (62914560) //1048576 * 8 = 8 MB ,2621440 * 8 = 20 MB//(104857600 4090) (52428800 A100) (62914560 H800)  //pointer-chasing array size in 64-bit. total array size is 7 MB which larger than L2 cache size (6 MB in Volta) to avoid l2 cache resident from the copy engine
